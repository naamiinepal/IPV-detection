...
from utilities.kfold_split_asp_extraction_polarity import (
    kfold_split_aspect,
    kfold_split_polarity,
)


def argument_parser():
    parser = argparse.ArgumentParser(
        description="Argument Parser for Creating K fold splits for aspect term extraction and Polarity Classification."
    )
    parser.add_argument(
        "-t",
        "--type",
        default="aspect",
        choices=["aspect", "polarity"],
        type=str,
    ...
    parser.add_argument(
        "-i",
        "--input_dir",
        default=r"data/aspect_extraction",
        type=str,
        metavar="PATH",
    ...
    parser.add_argument(
        "-o",
        "--save_dir",
        default=r"data/aspect_extraction/kfold",
        type=str,
        metavar="PATH",
    ...
    parser.add_argument(
        "--log_dir",
        default=r"logs/splits",
        type=str,
        metavar="PATH",
        help="Directory to save logs.",
    )
    parser.add_argument(
        "-k", "--kfolds", default=5, type=int, help="Number of folds to generate."
    )
    parser.add_argument(
        "-r", "--random_seed", default=1234, type=int, help="Random seed."
    )
    parser.add_argument(
        "-v", "--verbose", action="store_true", help="Whether to display verbose."
    )
