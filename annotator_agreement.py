...
root = (
    r"D:\ML_projects\IPV-Project\annotation\data\first_lot\common_annotation\Exported"
)
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        "--input_dir",
        type=str,
        default=r"D:\ML_projects\IPV-Project\annotation\data\first_lot\common_annotation\Exported",
    ...
    parser.add_argument(
        ...
        "--output_dir",
        type=str,
        default=r"annotation/results/inter_annotator_agreement",
