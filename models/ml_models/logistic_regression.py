...
def main(args, logger):
    ...
    for ii in range(k_fold):
        ...
        # Make predictions.
        y_pred_train, y_pred_val = pipe.fit_predict(model = logistic_regression)
    ...
    record_df.to_csv(join(cache_path, f'logistic_regression_{str(args.vectorizer.mode)}_{str(args.vectorizer.max_features)}_{str(args.logistic_regression.C)}_{str(args.logistic_regression.max_iter)}_results.csv'))
