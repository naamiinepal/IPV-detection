# -*- coding: utf-8 -*-
"""
Created on Wed Feb  9 10:03:46 2022
...
if __name__=="__main__":
    ...
    parser.add_argument("-i", "--input_file", 
                        default = './data/nepcls/new_nepsa.csv', 
                        metavar="PATH", help="Input file path")
    
    parser.add_argument("-o", "--output_dir", 
                        default="./data/kfold_new", 
    ...
    parser.add_argument("-k", "--kfold", dest='kfold', type=int, 
                        default=5, metavar="INT", help="K-fold")
...
#%%
import pandas as pd
df_txt = pd.read_csv('./data/nepcls/ss_ac_at_txt_unbal.csv', delimiter=',', 
                     encoding='utf-8', 
                     skip_blank_lines=True, 
                     header=None, 
                     names=['ss', 'ac', 'at', 'text'])
