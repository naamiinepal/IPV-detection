...
class MLTrainer:
    ...
    def _write_results(self, record_df: pd.DataFrame, cache_path: str):
        ...
        '''
        suffix = '_'.join((str(values) for params, values in self.args[self.args.model].items()))
    ...
    def _train_i_fold(self, k: int):
        ...
        # Evaluation.
        train_acc, train_pr, train_rec, train_f1, train_auc = classification_metrics(y_train, y_pred_train)
        val_acc, val_pr, val_rec, val_f1, val_auc = classification_metrics(y_val, y_pred_val)
    ...
    def train(self):
        ...
        for ii in range(k_fold):
            ...
            if self.args.verbose:
                ...
                verbosity(train_acc, train_pr, train_rec, train_f1, train_auc, self.logger, mode = 'train')
                verbosity(val_acc, val_pr, val_rec, val_f1, val_auc, self.logger, mode = 'val')
