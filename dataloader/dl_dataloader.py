    ...
    def __init__(self, args: DotDict, k: int, device: str):
        ...
        if args.model == "bert" or args.model == "muril":
            ...
            if args.train_type == "text":
                self.tokenizer_funct = lambda text: self.bert_tokenizer(
                    text,
                    padding="max_length",
                    max_length=512,
                    truncation=True,
                ...
                self.tokenizer_funct = lambda text, at: self.bert_tokenizer(
                    text,
                    at,
                    padding="max_length",
                    max_length=512,
                ...
                self.tokenizer_funct = lambda text, ac: self.bert_tokenizer(
                    text,
                    ac,
                    padding="max_length",
                    max_length=512,
        ...
        self.fields = (
            ...
            ("TEXT", self.txt_field),
            ("IPV", self.ipv_field),
        )  # THIS WILL BE MODIFIED AFTER ASPECT TERMS AND CATEGORIES ARE ADDED.
        ...
        if args.model == "bert" or args.model == "muril":
            ...
            self.txt_field.build_vocab(
                self.train_ds.TEXT, self.val_ds.TEXT, max_size=None, vectors=self.vec
            )
